...
import ecapeRegExp from "./Functions/ecapeRegExp";
import getCaretCharacterOffsetWithin from "./Functions/getCaretCharacterOffsetWithin";
import getCaretHTMLCharacterOffSet from "./Functions/getCaretHTMLCharacterOffSet";
import getTextInTag from "./Functions/getTextInTag";
import setEditableCaretPos from "./Functions/setEditableCaretPos";
    ...
    const updateSuggestBoxPos = useMemo(() => {
        return function() {
            ...
            if(suggestionBoxRef.current && sel && sel.rangeCount > 0){
                ...
                const top = rect.top - parentRect.top + window.scrollY + 20;
