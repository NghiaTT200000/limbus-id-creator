...
import useInput from "Features/CardCreator/Hooks/useInputs";
...
export default function InputStatPage({collaspPage}:{collaspPage:()=>void}):ReactElement{
    ...
    return <div className="input-page input-stat-page">
        ...
        {splashArt?<div className="input-group-container">
                <p className="center-element">Delete the splash art? <span className="material-symbols-outlined delete-splash-art-btn" onClick={()=>{setEgoInfoValue({...EgoInfoValue,splashArt:""})}}>
                    delete
                </span></p>
